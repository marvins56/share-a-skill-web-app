...
<body>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Making <span>your skills</span><br>Useful!</h2>
      <div>
        <a href="register.php" class="btn-get-started scrollto">Donate  A skill </a>

        <a href="skill.php" class="btn-projects scrollto">Learn A skill</a>
      </div>
    </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-6 content">
            <h2>VISION</h2>
            <P> The empowered empowering others</P>
            <h2>MISSION</h2>
            <P>Discover, establish and fulfill</P>
            <h3>OBJECTIVES</h3>
            <ul>
              <li><i class="bi bi-check-circle"></i>   To skill people</li>
              <li><i class="bi bi-check-circle"></i>To be the middleman between investors and suppliers</li>
              <li><i class="bi bi-check-circle"></i>To add value to Ugandan raw materials to make them valuable</li>
