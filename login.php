...
$user = mysqli_fetch_assoc($result);
  ...
  if (count($errors) == 0) {
$pass = md5($password);
  $query = "SELECT * FROM  users WHERE (username='$username' and email = '$email' and password='$pass')";
  $result = mysqli_query($conn, $query);

  if ($row = mysqli_fetch_array($result)) {
if(($row['username'] === "admin_miriam")  && ($row['password']=== $pass)){
  $_SESSION['id'] = $row['id'];
...
<head>
  ...
  <title>login with share a skill</title>
...
<?php include 'errors.php' ?>
                    ...
                    <input type="submit" name="submit" value="Login" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">
                    </div>

                    <p class="text-center text-muted mt-5 mb-0">Dont have an account? <a href="register.php" class="fw-bold text-body"><u>register</u></a></p>
